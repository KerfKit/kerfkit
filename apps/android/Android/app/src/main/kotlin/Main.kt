...
internal val logger: SkipLogger = SkipLogger(subsystem = "kerf.kit", category = "KerfKit")

private typealias AppRootView = KerfKitRootView
private typealias AppDelegate = KerfKitAppDelegate
